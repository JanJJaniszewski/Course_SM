...
```{r  qq-test, fig.cap = "QQ-plot of the best model predictions of costs vs. real values of costs for the final holdout data and line indicating perfect prediction location"}
...
```{r  qq-cv, fig.cap = "QQ-plot of the best model predictions of costs vs. real values of costs for the training data  and line indicating perfect prediction location"}
