...
## 2. Data
### 2.1. Description
Data used to answer our introduced questions originates from the U.S. government census (1990) and described the demographic data for different supermarkets in the Chicago metropolitan area. It is part of a bigger data collection, which has been used for research on shelf management and pricing (Kilts Center, 2004).
