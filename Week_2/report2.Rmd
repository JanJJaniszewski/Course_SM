...
Using these complexity parameters, the model yields an RMSE = 1782121 and the $R^2=0.4593$, as observed in Table 1. Although there is a relatively high RMSE, this is partially due to the large values of $y$. The predicted values are capable of accounting for approximately 45.9% of the variance of the observed values for $y$.
