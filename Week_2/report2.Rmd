...
Using these complexity parameters, the model yields an RMSE = 1782121 and the $R^2=0.459$, as observed in Table \ref{t1}. Although there is a relatively high RMSE, this is partially due to the large values of $y$. The predicted values are capable of accounting for approximately 46% of the variance of the observed values for $y$.
